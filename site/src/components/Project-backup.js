...
import styles from '../public/project.css'
        ...
        <Container text style={{ marginTop: '7em' }}>
            <div className={styles.content}>
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.phonetic}>V0.1 - OpenAI-Turbo-4o</div>
                    <div className={styles.scrollCta}>
                        ForeFlights getting complicated, lets delegate the responsibility of
                        those small and tedious tasks with the use of AI
                    </div>
                </div>
                ...
                <div className={styles.groundContainer}>
                    <div className={`${styles.parallax} ${styles.ground}`}></div>
                    <div className={`${styles.section} ${styles.right}`}>
                    ...
                    <div className={styles.section}>
                        ...
                        <p>
                            Once hes knows what to do he sends the instructions and a screenshot
                            of the app to Fred the Flight Instructor
                        </p>
                    </div>
                    <div className={`${styles.section} ${styles.right}`}>
                        <h2>
                            Freds job is to read the screen and determine what coordinates to
                            tap next
                        </h2>
                        <p>...he uses AI vision to complete this</p>
                    </div>
                    <div className={`${styles.parallax} ${styles.clouds}`}></div>
                </div>
                <div className={styles.blueprint}>
                    ...
                    <div className={`${styles.section} ${styles.dark} ${styles.length}`}>
                        <h2>XCUITest</h2>
                        <p>
                            Using an Appium Python Client, Pete is able to tap exactly where
                            Fred told him to
                        </p>
                    </div>
                    <div className={`${styles.section} ${styles.dark} ${styles.wingspan}`}>
                        <h2>Did he get it right?</h2>
                        <p>
                            Like any good CFI, Fred is checking Petes work, and will correct him
                            if necessary
                        </p>
                    </div>
                    <div className={`${styles.section} ${styles.dark} ${styles.phalange}`}>
                        <h2>Well Pete successfully moves to the next step, what happens now?</h2>
                        <p>
                            Fred commands Pete to work on the next step and complete the given
                            task
                        </p>
                    </div>
                    <div className={`${styles.section} ${styles.dark}`}>
